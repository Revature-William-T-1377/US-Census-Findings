...
object cityanalysis2020 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    for (i <- locations) {
      ...
      println(state)
      var df1 = spark.read.option("delimiter", "|").csv(s"D:/Downloads/Work/data/${abbreviation}geo2020.pl") //D:/Downloads/Work/data/${abbreviation}geo2020.pl
                                                                                //The 2000 file must be a csv. D:/Downloads/Work/data/${abbreviation}geo.csv
